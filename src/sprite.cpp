...
SDL_Texture *Sprite::getTexutre()
{
    return this->_texture;
}

void Sprite::draw(Graphics &graphics, float x, float y, float rotation, float scaleX, float scaleY, bool play)
{
    ...
    SDL_RenderCopyEx(graphics.getRenderer(), this->_texture, &src, &dest, rotation, &center, flip);
}
